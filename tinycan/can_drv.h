...
typedef int32_t (DRV_CALLBACK_TYPE *TCanApplaySettings)(uint32_t index);

typedef int32_t (DRV_CALLBACK_TYPE *TCanSetMode)(uint32_t index, unsigned char can_op_mode,
                 uint16_t  can_command);
typedef int32_t (DRV_CALLBACK_TYPE *TCanSet)(uint32_t index, uint16_t obj_index, uint16_t obj_sub_index,
                 void *data, int32_t size);
typedef int32_t (DRV_CALLBACK_TYPE *TCanGet)(uint32_t index, uint16_t obj_index, uint16_t obj_sub_index,
                 void *data, int32_t size);
